...
(() => {
    ...
    function applyLoginTheme() {
        ...
        if (loginBox)
            loginBox.classList.toggle("bright-login", isBright);
        const landr = document.querySelector(".landr");
        if (landr)
            landr.classList.toggle("bright-landr", isBright);
        const loginF = document.querySelector(".login-f");
        if (loginF)
            loginF.classList.toggle("bright-login-f", isBright);
        const ahaa = document.querySelector("#ahaa");
        if (ahaa)
            ahaa.classList.toggle("bright-ahaa", isBright);
    ...
    window.login = login;
    window.register_redirect = register_redirect;
    window.register = register;
    window.gotologin = gotologin;
    window.toggleRegisterButton = toggleRegisterButton;
    window.openToS = openToS;
    window.closeToS = closeToS;
    window.toggleLoginTheme = toggleLoginTheme;
})();
